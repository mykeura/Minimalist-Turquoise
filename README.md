...
3. **Clear Differentiation:** If you distribute a modified version, you must clearly label it as a **"modified version of Minimalist Turquoise by Miguel Euraque"**.

These conditions are based on the author's right to protect the integrity of their work and prevent misrepresentation.

## 🎨 Features

- **Color Palette:** Soft shades of turquoise and neutrals
